...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] flex items-start lg:items-center justify-center bg-gray-50 dark:bg-[#020617] text-slate-900 dark:text-white overflow-hidden transition-colors duration-300 pt-48 pb-20 lg:pt-0 lg:pb-0">
