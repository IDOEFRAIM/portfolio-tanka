...
export default function page() {
    ...
    return (
        <div className="w-screen h-screen p-4 m-4 " style={container}>
            <nav style={nav}>
            ...
            <main style={iconContainer}>
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        style={icon}
                    >
                        {selectedTab.label ==  "Data Scientist" && <DataScientist/> }
                        {selectedTab.label ==  "Web Developer" && <Web/> }
                        {selectedTab.label ==  "Mobile Developer" && <Mobile/> }
                    </motion.div>
                </AnimatePresence>
            </main>
        </div>
...
const [dataScientist, WebDeveloper, MobileDeveloper] = allIngredients
const tabs = [dataScientist, WebDeveloper, MobileDeveloper]
